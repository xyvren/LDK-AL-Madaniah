    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable($ldkTable)) {
            ...
            DB::table($ldkTable)->insert([
                [
                    'ldkTag'     => 'LDK Al-Madaniah',
                    'ldkName' => 'LDK Al-Madaniah',
                ...
                [
                    'ldkTag'     => 'LDKSFAH',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Adab dan Humaniora',
                ...
                [
                    'ldkTag'     => 'LDKSFDI',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Dirasat Islamiyah',
                ...
                [
                    'ldkTag'     => 'LDKSFDIKOM',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Ilmu Dakwah dan Ilmu Komunikasi',
                ...
                [
                    'ldkTag'     => 'LDKSFKIK',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Kedokteran dan Ilmu Kesehatan',
                ...
                [
                    'ldkTag'     => 'LDKSFISIP',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Ilmu Sosial dan Ilmu Politik',
                ...
                [
                    'ldkTag'     => 'LDKSFITK',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Ilmu Tarbiyah dan Keguruan',
                ...
                [
                    'ldkTag'     => 'LDKSFSH',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Syariah dan Hukum',
                ...
                [
                    'ldkTag'     => 'LDKSFST',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Sains dan Teknologi',
                ...
                [
                    'ldkTag'     => 'LDKSFU',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Ushuluddin',
                ...
                [
                    'ldkTag'     => 'LDKSFPsi',
                    'ldkName' => 'LDK Al-Madaniah Fakultas Psikologi',
