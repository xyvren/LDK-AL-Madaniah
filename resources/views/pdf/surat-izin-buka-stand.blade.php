...
<div class="content">
    ...
    <div class="body-surat">
        ...
        <p class="indent">Sehubungan dengan rangkaian kegiatan <strong>{{ $data['nama_acara'] ?? '-' }}</strong> yang diselenggarakan oleh UKM Lembaga Dakwah Kampus (LDK) Syahid Universitas Bangka Belitung, yang InsyaAllah akan dilaksanakan pada:</p>
