...
@php
    ...
    if (empty($pertimbangan)) {
        $pertimbangan = [
            'Mengingat yang bersangkutan merupakan anggota aktif dari UKM LDK Al-Madaniah.',
...
<div class="content">
    ...
    <div class="body-surat">
        ...
        <p class="indent">Dengan ini UKM Lembaga Dakwah Kampus Al-Madaniah Universitas Bangka Belitung (LDK Al-Madaniah)
