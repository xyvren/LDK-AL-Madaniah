        ...
        <div class="row">
            ...
            <div class="col-12 text-center">
                <h1 class="page-title">
                    ...
                    <span class="highlighted-text ms-1">Management</span>
                </h1>
            </div>

            {{-- ── Subtitle & Top Action ─────────────────────────────────── --}}
            <div class="col-12 mb-3 d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2">
                <p class="text-muted small mb-0">
                    <i class="fas fa-info-circle me-1 text-custom"></i>
                    Manage official letter requests, approve document submissions, and issue official letter numbers.
                </p>
                <div>
                    <a href="{{ route('admin.persuratan.download-examples') }}" class="btn btn-custom-primary btn-sm rounded-pill px-3 shadow-sm font-weight-bold">
            ...
            @if (session('error'))
                <div class="col-12 mb-3">
                    <div class="alert alert-danger adm-alert-danger border-0 shadow-sm rounded-4 d-flex align-items-center gap-3 py-3 px-4 mb-0">
            ...
            <div class="col-12 mb-3">
                <div class="row g-3">
                    <div class="col-12 col-sm-6 col-xl mb-2 mb-xl-0">
            ...
            <div class="col-12 mb-3">
                <div class="adm-filter-card">
                    <form method="GET" action="{{ route('admin.persuratan.index') }}" class="row g-2 align-items-center" id="filter-form">
                        ...
                        {{-- 2. Letter Type Picker Trigger Button --}}
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="adm-type-picker-btn {{ $selectedJenisInfo ? 'has-filter' : '' }}"
                                ...
                                <i class="fas {{ $selectedJenisInfo['icon'] ?? 'fa-file-signature' }} text-custom"></i>
                        ...
                        <div class="col-lg-3 col-md-5 col-12 d-flex gap-2">
                            <button type="submit" class="btn btn-custom-primary btn-sm rounded-3 px-3 flex-grow-1 font-weight-bold shadow-sm">
                                        ...
                                        <td class="text-center text-nowrap">
                                            <div class="btn-group btn-group-sm shadow-sm rounded-3 overflow-hidden">
                                                <a href="{{ route('admin.persuratan.show', $log) }}"
                                                   class="btn btn-light text-custom border" title="View Details">
