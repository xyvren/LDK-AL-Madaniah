...
[data-theme="dark"] .book-header-elegant    { background: #1a1f2e; border-color: rgba(37,99,235,.2); }
...
[data-theme="dark"] .content-card          { background: #1a1f2e; border-color: rgba(37,99,235,.2); }
[data-theme="dark"] .content-title         { color: #e2e8f0; }
[data-theme="dark"] .action-group         { color: #e2e8f0; }
[data-theme="dark"] .content-text          { color: #cbd5e0; }
[data-theme="dark"] .comments-description  { color: #9ca3af; }
[data-theme="dark"] .detail-item           { border-bottom-color: rgba(37,99,235,.1); }
[data-theme="dark"] .detail-item:hover     { background: rgba(37,99,235,.05); }
...
[data-theme="dark"] .related-books-elegant { background: #1a1f2e; border-color: rgba(37,99,235,.2); }
[data-theme="dark"] .section-title         { color: #e2e8f0; }
[data-theme="dark"] .tabs-navigation       { background: #252b3b; border-bottom-color: rgba(37,99,235,.15); }
[data-theme="dark"] .tab-pane             { background: transparent; }
[data-theme="dark"] .nav-tab               { color: #9ca3af; }
[data-theme="dark"] .nav-tab:hover         { background: rgba(37,99,235,.1); color: #60a5fa; }
...
[data-theme="dark"] .related-book-card     { background: #252b3b; border-color: rgba(37,99,235,.15); }
[data-theme="dark"] .book-title-small      { color: #e2e8f0; }
[data-theme="dark"] .share-options-floating { background: #1a1f2e; border-color: rgba(37,99,235,.2); }
[data-theme="dark"] .btn-like:not(.liked),
[data-theme="dark"] .btn-outline           { background: #252b3b; border-color: rgba(37,99,235,.2); color: #e2e8f0; }
...
[data-theme="dark"] .tags-section          { border-top-color: rgba(37,99,235,.15); }
[data-theme="dark"] .tags-title            { color: #9ca3af; }
[data-theme="dark"] .tag-elegant           { background: rgba(37,99,235,.15); color: #60a5fa; }
[data-theme="dark"] .tag-elegant:hover     { background: rgba(37,99,235,.35); color: #e2e8f0; }
...
@media (max-width: 768px) {
    ...
    [data-theme="dark"] .nav-tab:hover   { background: rgba(37,99,235,.15); color: #60a5fa; }
    [data-theme="dark"] .nav-tab.active  { background: #2563eb; color: #fff; border-bottom-color: transparent; }
}
</style>
