...
[data-theme="dark"] .schedule-btn-view-all { background: #1a1f2e; color: #00c4b8; border-color: rgba(37,99,235,.3); }
[data-theme="dark"] .info-date-wrapper { background: #252b3b; }
[data-theme="dark"] .info-description { background: linear-gradient(135deg, rgba(37,99,235,.1) 0%, rgba(37,99,235,.05) 100%); }
