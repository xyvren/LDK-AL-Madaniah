...
[data-theme="dark"] .library-card { background: #1a1f2e; border-color: rgba(37,99,235,.15); }
...
[data-theme="dark"] .library-card-mobile { background: #1a1f2e; border-color: rgba(37,99,235,.15); }
...
[data-theme="dark"] .library-btn-all { background: #1a1f2e; color: #00c4b8; border-color: rgba(37,99,235,.4); }
...
[data-theme="dark"] .library-sheet__close { background: #252b3b; color: #60a5fa; }
