<style>
    ...
    /* ── Dark Mode ── */
    [data-theme="dark"] .contact-badge              { background: rgba(37,99,235,.15); color: #60a5fa; border-color: rgba(37,99,235,.2); }
    ...
    [data-theme="dark"] .contact-quote-card { background: linear-gradient(135deg, rgba(37,99,235,.1) 0%, rgba(26,31,46,.8) 100%); border-color: rgba(37,99,235,.2); }
    [data-theme="dark"] .contact-quote-card__text { color: #cbd5e0; }
    [data-theme="dark"] .contact-method-item { background: #1a1f2e; border-color: rgba(37,99,235,.15); }
    ...
    [data-theme="dark"] .contact-form-card { background: linear-gradient(135deg, rgba(37,99,235,.08) 0%, rgba(26,31,46,.95) 100%); border-color: rgba(37,99,235,.2); }
    ...
    [data-theme="dark"] .contact-form__textarea { background: #1e2535; border-color: rgba(37,99,235,.2); color: #e2e8f0; }
    [data-theme="dark"] .contact-form__input:focus,
    [data-theme="dark"] .contact-form__textarea:focus { background: #252b3b; border-color: #2563eb; }
