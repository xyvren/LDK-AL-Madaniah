...
(function () {
    ...
    var fieldMap = {
        'izin-orang-tua': [
            ...
            { name: 'nama_acara',   label: 'Nama Acara',                  icon: 'fa-star',    placeholder: 'Contoh: Rihlah LDK Al-Madaniah 2026' },
            ...
            { name: 'tempat',       label: 'Tempat Pelaksanaan',          icon: 'fa-map-marker-alt', placeholder: 'Contoh: Aula Madya Universitas Bangka Belitung' },
        ],
        'peminjaman-alat': [
            { name: 'kode_bidang',      label: 'Asal Bidang / LDKSF Pengaju', icon: 'fa-sitemap', type: 'dept-picker' },
            { name: 'jenis_peminjaman', label: 'Sifat Peminjaman',     icon: 'fa-tag',    type: 'select',
              options: [{value:'internal',label:'Internal (LDK Al-Madaniah)'},{value:'eksternal',label:'Eksternal'}] },
        ...
        'peminjaman-tempat-kampus': [
            ...
            { name: 'ditujukan_kepada',     label: 'Ditujukan Kepada',       icon: 'fa-envelope', placeholder: 'Contoh: Kepala Bagian Umum Universitas Bangka Belitung' },
            { name: 'hari_tanggal',         label: 'Tanggal Peminjaman',     icon: 'fa-calendar', type: 'date' },
            { name: 'waktu',                label: 'Waktu Peminjaman',       icon: 'fa-clock',    type: 'time-range' },
        ...
        'peminjaman-tempat-luar-kampus': [
            { name: 'kode_bidang',          label: 'Asal Bidang / LDKSF Pengaju', icon: 'fa-sitemap', type: 'dept-picker' },
            { name: 'nama_acara',           label: 'Nama Acara',             icon: 'fa-star',     placeholder: 'Contoh: Kemah Ukhuwah Madaniah' },
        ...
        'permohonan-bantuan-dana': [
            { name: 'kode_bidang',      label: 'Asal Bidang / LDKSF Pengaju', icon: 'fa-sitemap', type: 'dept-picker' },
            { name: 'nama_program',     label: 'Nama Program/Acara',   icon: 'fa-hand-holding-usd', placeholder: 'Contoh: Madaniah Peduli Ummat 2026' },
        ...
        'permohonan-izin-luar-kampus': [
            { name: 'kode_bidang',   label: 'Asal Bidang / LDKSF Pengaju', icon: 'fa-sitemap', type: 'dept-picker' },
            { name: 'nama_acara',    label: 'Nama Acara',           icon: 'fa-star',            placeholder: 'Contoh: Rihlah Akbar Pengurus LDK Al-Madaniah' },
        ...
        'surat-rekomendasi': [
            ...
            { name: 'jabatan',              label: 'Jabatan di LDK Al-Madaniah', icon: 'fa-briefcase', placeholder: 'Contoh: Ketua Departemen Kaderisasi' },
        ...
        'surat-undangan': [
            ...
            { name: 'jenis_undangan',   label: 'Sifat Undangan',       icon: 'fa-tag',    type: 'select',
              options: [{value:'internal',label:'Internal Kampus (UBB)'},{value:'eksternal',label:'Eksternal Kampus'}] },
            { name: 'nama_acara',       label: 'Nama Acara',           icon: 'fa-star',         placeholder: 'Contoh: Milad Akbar LDK Al-Madaniah ke-30' },
            { name: 'tema_acara',       label: 'Tema Acara',           icon: 'fa-tag',          placeholder: 'Contoh: Tiga Dekade Menebar Inspirasi Kebaikan' },
            { name: 'ditujukan_kepada', label: 'Ditujukan Kepada',     icon: 'fa-envelope',     placeholder: 'Contoh: Ketua BEM Universitas Bangka Belitung' },
        ...
        'surat-aktif-organisasi': [
            ...
            { name: 'jabatan',       label: 'Jabatan di LDK Al-Madaniah', icon: 'fa-briefcase',    placeholder: 'Contoh: Anggota Bidang Syiar' },
        ...
        'permohonan-pemateri': [
            ...
            { name: 'hari_tanggal',     label: 'Tanggal Acara',        icon: 'fa-calendar',        type: 'date' },
            { name: 'waktu',            label: 'Waktu Pelaksanaan',    icon: 'fa-clock',           type: 'time-range' },
            { name: 'tempat',           label: 'Tempat Acara',         icon: 'fa-map-marker-alt',  placeholder: 'Contoh: Masjid Al-Jami\'ah Universitas Bangka Belitung / Zoom Meeting' },
        ...
        'surat-izin-buka-stand': [
            ...
            { name: 'ditujukan_kepada', label: 'Ditujukan Kepada',     icon: 'fa-envelope',        placeholder: 'Contoh: Pengelola Gedung Student Center Universitas Bangka Belitung' },
        ...
        'surat-imbauan': [
            ...
            { name: 'ditujukan_kepada', label: 'Ditujukan Kepada',     icon: 'fa-envelope',        placeholder: 'Contoh: Seluruh Pengurus dan Kader LDK Al-Madaniah' },
        ...
        'kerja-sama-sponsorship': [
            { name: 'kode_bidang',      label: 'Asal Bidang / LDKSF Pengaju', icon: 'fa-sitemap', type: 'dept-picker' },
            { name: 'nama_acara',       label: 'Nama Acara',           icon: 'fa-star',            placeholder: 'Contoh: Madaniah Islamic Fair Fest 2026' },
        ...
        'surat-pemberitahuan': [
            ...
            { name: 'ditujukan_kepada', label: 'Ditujukan Kepada',     icon: 'fa-envelope',        placeholder: 'Contoh: Koordinator Keamanan Kampus 1 Universitas Bangka Belitung' },
